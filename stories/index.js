...
storiesOf("Button", module)
  ...
  storiesOf("Appointment", module)
    ...
    .add("Edit", () => <Form student="Emma" interviewer={2} interviewers={interviewers} onSave={action("onSave")} onCancel={action ("onCancel")} />) //interviewers={interviewers} //onCancel={() => action("onCancel")}
